...
function About() {
  ...
  <div >
    <div>
        <h1> Our Mission </h1>
        <br></br>
        <p1> The PlantFinder web-program aims to equip its users with the necessary plant information in order to empower them to 
        ...
        <h1> Motivation </h1>
        <br></br>
        <p3> A history of environmental degradation and lack of environmental education has left many parts of the United States without strong, 
            ...
            increasingly propagating across North America as a result of global climate change. With PlantFinder, individuals will be able to learn
             more about the plants native to their location, along with the ecosystem services they provide. </p3>
        <br></br>
        <br></br>
        <br></br>
        <br></br>
